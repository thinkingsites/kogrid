define(["knockout","lodash"], function (ko,_) {
    ...
    var viewmodel = {
        ...
        map: function (rowData) {
            return {
                nameLength: rowData.name.length,
                addressLength: rowData.name.length,
                phoneLength: rowData.name.length,
            }
        },

        // note that the columns now correspond to the mapped data, not the data passed in
        columns: ko.observableArray([
			{ title: "Name Length", key: "nameLength", style: { width: "50px", "text-align": "center" } },
			{ title: "Address Length", key: "addressLength", style: { width: "50px", "text-align": "center" } },
			{ title: "Phone Length", key: "phoneLength", style: { width: "50px", "text-align": "center" } },
        ]),
    };
